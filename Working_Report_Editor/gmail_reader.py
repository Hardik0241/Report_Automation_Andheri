...
UPDATED: Using ANDHERI_ prefixed secrets for OAuth
...
class GmailReader:
    ...
    def _get_oauth_creds(self):
        ...
        print(f"ANDHERI_CLIENT_ID exists: {bool(os.environ.get('ANDHERI_CLIENT_ID', ''))}")
        print(f"ANDHERI_CLIENT_SECRET exists: {bool(os.environ.get('ANDHERI_CLIENT_SECRET', ''))}")
        print(f"ANDHERI_REFRESH_TOKEN exists: {bool(os.environ.get('ANDHERI_REFRESH_TOKEN', ''))}")

        # UPDATED: Using ANDHERI_ prefixed secrets
        refresh_token = os.environ.get("ANDHERI_REFRESH_TOKEN", "")
        client_id = os.environ.get("ANDHERI_CLIENT_ID", "")
        client_secret = os.environ.get("ANDHERI_CLIENT_SECRET", "")
        ...
        if refresh_token and client_id and client_secret:
            ...
            logger.info("OAuth credentials loaded from environment (ANDHERI)")
            return self._oauth_creds

        print("❌ Missing OAuth credentials!")
        raise Exception("No OAuth credentials found for ANDHERI branch")
