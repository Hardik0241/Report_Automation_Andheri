# Report Automation System - Andheri Branch
...
| **Google Sheet** | Andheri Sales Reports |
...
|---------------|---------------|
| Alpa | alpakumari.edujam@gmail.com |
| Anshu | anshu.edujam@gmail.com |
| Avantika | avantikan.edujam@gmail.com |
| Sushmita | sushmita.edujam@gmail.com |
| Satish | satish.edujam@gmail.com |
| Vibhuti | vibhuti.edujam@gmail.com |
| Sahil | sahila.edujam@gmail.com |
| Anushka | anushkad.edujam@gmail.com |
| Mayank | mayankg.edujam@gmail.com |
| Alfiya | alfiyas.edujam@gmail.com |
...
| `GEMINI_API_KEY_ANDHERI` | Gemini API key |
| `ANDHERI_SALES_SPREADSHEET_ID` | Branch-specific Sheet ID |
| `ANDHERI_CLIENT_ID` | Gmail OAuth client ID |
| `ANDHERI_CLIENT_SECRET` | Gmail OAuth client secret |
| `ANDHERI_REFRESH_TOKEN` | Gmail OAuth refresh token |
...
### 1. Create Repository
```bash
git clone https://github.com/YOUR_USERNAME/Report_Automation_Andheri.git
cd Report_Automation_Andheri
...
git add .
git commit -m "Initial commit - Andheri branch automation"
git push origin main

4. Test Workflow
Go to Actions tab

Select Report Automation Scheduler - Andheri
...
| Section | Thane (Original) | Andheri (Modified) |
|---------|------------------|---------------------|
| **Title** | `Thane Branch` | `Andheri Branch` |
| **Branch Name** | Thane | Andheri |
| **Google Sheet** | Thane Sales Reports | Andheri Sales Reports |
| **Schedule** | Mon-Fri | Mon-Sat |
| **Employees** | 18 employees | 10 employees |
| **Secret Prefix** | `THANE_*` | `ANDHERI_*` |
| **Cron** | `1-5` | `1-6` |
| **Repo Name** | `Report_Automation_Thane` | `Report_Automation_Andheri` |
| **Status Viewed** | `status Viewed` | `Status Viewed` |

---

## 👥 Andheri Employee List

| # | Employee Name | Email Address |
|---|---------------|---------------|
| 1 | Alpa | alpakumari.edujam@gmail.com |
| 2 | Anshu | anshu.edujam@gmail.com |
| 3 | Avantika | avantikan.edujam@gmail.com |
| 4 | Sushmita | sushmita.edujam@gmail.com |
| 5 | Satish | satish.edujam@gmail.com |
| 6 | Vibhuti | vibhuti.edujam@gmail.com |
| 7 | Sahil | sahila.edujam@gmail.com |
| 8 | Anushka | anushkad.edujam@gmail.com |
| 9 | Mayank | mayankg.edujam@gmail.com |
| 10 | Alfiya | alfiyas.edujam@gmail.com |
...
| Secret Name | Source |
|-------------|--------|
| `GOOGLE_CREDENTIALS` | Service Account JSON (same for all) |
| `GEMINI_API_KEY_ANDHERI` | Gemini API key for Andheri |
| `ANDHERI_SALES_SPREADSHEET_ID` | Andheri Google Sheet ID |
| `ANDHERI_CLIENT_ID` | OAuth Client ID (same Gmail account) |
| `ANDHERI_CLIENT_SECRET` | OAuth Client Secret (same Gmail account) |
| `ANDHERI_REFRESH_TOKEN` | OAuth Refresh Token (same Gmail account) |

---

**Now your Andheri branch is complete!** 🚀
